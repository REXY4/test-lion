...
const Home: React.FC<Props> = ({ cart, user, DeleteCart }) => {
    ...
    const carts =
        cart &&
        cart.filter((c: any) => parseInt(c.userId) === parseInt(userId));
    ...
    const handleCancel = (id: number) => {
        setCheckout((prevCheckout: any) =>
            prevCheckout.filter((item: any) => item.checkoutId !== id)
        );
    };
                    ...
                    <Row>
                        <Col className="mb-5" md={8}>
                            {carts.map((item: any, index: number) => {
                                ...
                                return (
                                    <div
                                        className={`mb-3 d-flex justify-content-between ${styles["container-card"]}`}
                                    >
                        ...
                        <Col md={4} className="mb-5">
                            <Card>
                                <Card.Header
                                    className={styles["background-card-header"]}
                                >
